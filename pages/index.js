      ...
      <main className=" px-10 md:px-20 lg:px-40 dark:bg-gray-900">
        ...
        <section className="">
          ...
          <div className="flex flex-col gap-10 py-10 lg:flex-row lg:flex-wrap">
            <div className=" basis-1/3 flex-1"><h1 className="text-center text-gray-700 mb-4 text-2xl"><a href="https://app.netlify.com/sites/splendid-sfogliatella-8b42ab"  target="_blank" rel="noreferrer" >Shopping Cart App</a></h1><a href="https://app.netlify.com/sites/splendid-sfogliatella-8b42ab"  target="_blank" rel="noreferrer" ><Image className='rounded-lg object-cover' width={'100%'} height={'100%'} layout="responsive" src={shopping} alt="shoping-cart" /></a></div>
